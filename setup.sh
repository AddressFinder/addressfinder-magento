...
docker-compose -f docker-compose-mage$mageversion-php$phpversion.yml run --rm setup
docker-compose -f docker-compose-mage$mageversion-php$phpversion.yml up -d app
...
docker-compose -f docker-compose-mage$mageversion-php$phpversion.yml exec phpfpm ./bin/magento cache:disable

echo 'Setting Magento mode to Developer'
docker-compose -f docker-compose-mage$mageversion-php$phpversion.yml exec phpfpm ./bin/magento deploy:mode:set developer

if ! [ -L "./html/code/AddressFinder" ]; then
  echo 'Installing the AddressFinder module'
  docker-compose -f docker-compose-mage$mageversion-php$phpversion.yml exec phpfpm ./bin/magento module:enable AddressFinder_Widget
  docker-compose -f docker-compose-mage$mageversion-php$phpversion.yml exec phpfpm ./bin/magento setup:upgrade
  docker-compose -f docker-compose-mage$mageversion-php$phpversion.yml exec phpfpm ./bin/magento setup:di:compile
fi

docker-compose -f docker-compose-mage$mageversion-php$phpversion.yml down
